...
export default function CalibrationPanel({ posture }: Props) {
  ...
  const ready=posture?.tracking.quality==='EXCELLENT'&&posture.tracking.hips_visible&&posture.tracking.reliable
